...
public class EditStaff extends javax.swing.JFrame {
    ...
    public EditStaff(int id) {
      ...
      Class.forName("org.postgresql.Driver");
         ...
         if(rs.next())
         {
             staffId.setText(String.valueOf(rs.getInt("staff_id")));
             staffName.setText(rs.getString("staff_name"));
             staffAddress.setText(rs.getString("staff_address"));
             staffMobile.setText(rs.getString("staff_mobile"));
             staffSalary.setText(String.valueOf(rs.getInt("staff_salary")));
    ...
    private void initComponents() {
        ...
        jPanel1.add(staffId);
        staffId.setBounds(150, 70, 140, 30);
        jPanel1.add(staffName);
        staffName.setBounds(150, 130, 140, 30);
        jPanel1.add(staffAddress);
        staffAddress.setBounds(150, 190, 140, 30);
        jPanel1.add(staffMobile);
        staffMobile.setBounds(150, 260, 140, 30);
        jPanel1.add(staffSalary);
        staffSalary.setBounds(150, 310, 140, 30);
        ...
        jButton1.setBounds(80, 370, 110, 23);
        ...
        jButton2.setBounds(220, 370, 110, 23);
     ...
     try
       {
        ...
        Class.forName("org.postgresql.Driver");
             Connection con=DriverManager.getConnection("jdbc:postgresql://localhost:5432/army","postgres","postgres");  
                Statement st = con.createStatement();
         st.executeUpdate("update staff set staff_name='"+name+"', staff_address='"+address+"',staff_mobile='"+mobile+"',staff_salary='"+salary+"'where staff_id='"+id+"'");
         JOptionPane.showMessageDialog(null,"Staff Record Update");
       }catch(Exception e)
       {
       }
